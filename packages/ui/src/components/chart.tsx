...
function ChartTooltipContent({
  ...
  return (
    <div
      className={cn(
        "min-w-32 gap-1.5 px-2.5 py-1.5 text-xs shadow-lg grid items-start rounded-xl bg-popover text-popover-foreground ring-1 ring-foreground/5 dark:ring-foreground/10",
        className
      )}
    >
