...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        "group/calendar p-3 [--cell-size:--spacing(8)] bg-background [--cell-radius:var(--radius-2xl)] in-data-[slot=card-content]:bg-transparent in-data-[slot=popover-content]:bg-transparent",
