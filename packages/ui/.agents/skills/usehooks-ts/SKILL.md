...
Import the narrow named hook and wrap it only when the package needs a shared
design-system hook:
...
- Keep shared wrappers stable and generic; app-specific hook names belong in
  `apps/web`.
