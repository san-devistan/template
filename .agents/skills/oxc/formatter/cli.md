...
- --migrate = SOURCE — Migrate configuration to .oxfmtrc.json from specified source Available sources: prettier, biome
...
## Config Options ​
- -c , --config = PATH — Path to the configuration file (.json, .jsonc, .ts, .mts, .cts, .js, .mjs, .cjs)
