...
Customization for individual rules, allows to override the linter's diagnostics and autofix. Example of lowering the severity of "no-unused-vars" rule to "hint" and disabling autofix for it:
```
{
  "rulesCustomization": {
    "no-unused-vars": {
