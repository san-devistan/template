...
```
See the Writing JS Plugins page for information on writing your own JS plugins and custom rules for Oxlint.
...
- eslint-plugin-cypress ( conformance test results )
- @e18e/eslint-plugin ( conformance test results )
- eslint-plugin-mocha ( conformance test results )
- eslint-plugin-playwright ( conformance test results )
- eslint-plugin-react-hooks ( conformance test results ): Note that some of these rules are already supported natively in Oxlint, and so those should generally be used instead
- eslint-plugin-regexp ( conformance test results )
- eslint-plugin-sonarjs ( conformance test results )
- eslint-plugin-storybook ( conformance test results )
- @stylistic/eslint-plugin ( conformance test results )
- eslint-plugin-testing-library ( conformance test results )
...
You can see more info about plugins that are known to work with Oxlint in the GitHub Discussion .
## API Support ​
