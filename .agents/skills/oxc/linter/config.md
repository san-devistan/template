...
Use options for linter-level behavior. See the Config file reference for the full list.
Example:
```
{
  "options": {
...
```
## Next steps ​
- Ignore files : Ignore files and patterns, .gitignore and .eslintignore workflows, and symlink behavior.
- Inline ignore comments : Inline suppressions and scoped exceptions.
