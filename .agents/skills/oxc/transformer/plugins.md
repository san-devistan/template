...
Recommendation
Enable this option when the transformed output may be embedded directly in HTML <script> tags. Without it, tagged template literals containing </script> can break when embedded in HTML <script> tags. See oxc-project/oxc#15306 for details.
```
